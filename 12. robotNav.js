...
function startLevel(map) {
    ...
    map.defineObject('robot', {
        ...
        'behavior': function (me) {
             ...
             map.getPlayer().setPhoneCallback(function (a) {
             map.placeObject(31, 6, 'block');
             map.placeObject(32, 7, 'block');
             map.placeObject(32, 8, 'block');
             map.placeObject(17, 4, 'block');
             map.placeObject(17, 3, 'block');
             map.placeObject(17, 2, 'block');
             map.placeObject(17, 1, 'block');
         	}); 
