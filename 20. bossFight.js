...
function startLevel(map) {
	...
	var list =  map.getDynamicObjects();
   
 	//map.placeObject(0,20,'bullet');
    ...
    for (var i=0; i<45; i++)
    {
    	map.placeObject(5+i,10,'redLock');
    }
    ...
    map.getPlayer().setPhoneCallback(function () {
       //map.placeObject(2,5,'redLock');
       map.placeObject(3,5, 'mybullet');
       map.placeObject(3,6, 'mybullet');
    });
}
